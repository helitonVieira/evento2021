...
Public Class FrmEspecieCaixa
    ...
    Private Sub Frm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If ModParametroSistema.permissaoUsuario <> "MASTER" Then
            If t150101 = False Then
                MsgBox("Usuário sem permissão para acessar Especie Caixa!", MsgBoxStyle.Critical, "Usuário sem permissão de acesso!")
                Me.Close()
            End If
            BtnSalvar.Enabled = ModPermissaoUsuario.t1501011
            BtnExcluir.Enabled = ModPermissaoUsuario.t1501012
        End If
