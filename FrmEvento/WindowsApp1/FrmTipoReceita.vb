...
Imports System.IO
Public Class FrmTipoReceita

    Dim conectar As New ConexaoSQL
    Dim ds, dsUltimo As New DataSet
    Dim tipoReceita, tipoReceita2 As New ClTipoReceita
    ...
    Private Sub Frm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If ModParametroSistema.permissaoUsuario <> "MASTER" Then
            If t130101 = False Then
                ...
                Me.Close()
            End If
            BtnSalvar.Enabled = ModPermissaoUsuario.t1302011
            BtnExcluir.Enabled = ModPermissaoUsuario.t1302012
        End If
    ...
    Public Sub atualizaDados()
        ...
        Try
            ...
            ds = tipoReceita.Consultar(cod_old, desc_old, ind_tipo_old, ind_ativo_old)
            tabela = ds.Tables(0)
    ...
    Public Sub salvaRegistro()
        Try
            ...
            tipoReceita.des_tipo_receita = TxbDescricao.Text
            tipoReceita.ind_tipo = ind_tipo_old
            tipoReceita.ind_ativo = ind_ativo_old

            If atualizar = 1 Then
                'pegar o ultimo registro
                Try
                    Dim ultimo As New DataSet
                    ultimo = tipoReceita2.UltimoCadastrado
                    Dim ult As String = ultimo.Tables(0).Rows(0)("ultimo")
                    tipoReceita.cod_tipo_receita = Convert.ToInt16(ult) + 1

                    ultimo.Clear()
                Catch ex As Exception
                    tipoReceita.cod_tipo_receita = 1
                End Try
                tipoReceita.ind_ativo = "S"
                tipoReceita.Cadastrar()
            ...
            Else
                tipoReceita.cod_tipo_receita = TxbCodigo.Text
                tipoReceita.Atualizar()
                If ModParametroSistema.erro Then
                    ModParametroSistema.erro = False
                    Exit Sub
                End If
    ...
    Public Sub carregaFormulario()
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                atualizar = 2
                TxbCodigo.Text = ds.Tables(0).Rows(i)("cod_tipo_receita").ToString
                TxbDescricao.Text = ds.Tables(0).Rows(i)("des_tipo_receita").ToString
