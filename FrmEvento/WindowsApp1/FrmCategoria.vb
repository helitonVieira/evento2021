...
Public Class FrmCategoria
    ...
    Private Sub Frm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If ModParametroSistema.permissaoUsuario <> "MASTER" Then
            If t120103 = False Then
                MsgBox("Usuário sem permissão para acessar a Categoria!", MsgBoxStyle.Critical, "Usuário sem permissão de acesso!")
                Me.Close()
            End If
            BtnSalvar.Enabled = ModPermissaoUsuario.t1201031
            BtnExcluir.Enabled = ModPermissaoUsuario.t1201032
        End If
        limpar()
    ...
    Public Sub formatarGrid()
        Try
            With Dgv
                ...
                .Columns(2).HeaderText = "Cód.Secao"
                .Columns(3).HeaderText = "Des.secao"
                .Columns(0).Width = 40
                .Columns(1).Width = 150
                .Columns(2).Width = 40
                .Columns(3).Width = 150
    ...
    Private Sub BtSecao_Click(sender As Object, e As EventArgs) Handles BtSecao.Click
        FrmPesquisa.tabela = "tab_secao_item"
        FrmPesquisa.ShowDialog()
        TxbCodSecao.Text = ModVariavelGlobal.pesquisaCodigo
        txbDesSecao.Text = ModVariavelGlobal.pesquisaNome
    ...
    Private Sub Dgv_DoubleClick(sender As Object, e As EventArgs) Handles Dgv.DoubleClick
        Try
            ...
            TxbCodSecao.Text = Dgv.CurrentRow.Cells(2).Value
            txbDesSecao.Text = Dgv.CurrentRow.Cells(3).Value
            TabControl1.SelectedIndex = 0
            carregaOld()
            Me.Height = 165
            Me.TxbCodigo.Select()
